    ...
    'categories' => [
        'pages' => [
            'index' => [
                ...
                'desc'      => '',
                'header'    => 'Categories Manager',
                'badge'     => ':total Categories Total',
            ],
            'create' => [
                'title'     => 'Create New Category',
                'desc'      => '',
                'header'    => 'Creating New Category',
                'badge'     => ':total Categories Total',
            ],
            'update' => [
                'title'     => 'Category Update',
                'desc'      => '',
                'header'    => 'Category Update',
                'badge'     => ':total Categories Uses',
            ],
        ],
        'table' => [
            ...
            'titles' => [
                ...
                'slug'              => 'Slug',
                'image'             => 'Image',
                'marked_as_menu'    => 'Marked as menu',
                'show_on_omepage'   => 'Show on Homepage',
                'parent'            => 'Parent',
                'used'              => 'Uses',
                'layout'            => 'Layout',
                'meta_description'  => 'Meta Description',
