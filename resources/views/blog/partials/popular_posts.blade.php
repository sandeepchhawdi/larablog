    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-6 mb-5 mb-lg-0">
                <div class="entry2">
                    <a href="{{ route('post.detail', $popular_posts[0]->slug) }}"><img src="{{ $popular_posts[0]->post_image }}" alt="Image" class="img-fluid rounded"></a>
                    <span class="post-category text-white bg-success mb-3">{{ $popular_posts[0]->parentCategory->first()->name }}</span>
                    <h2><a href="{{ route('post.detail', $popular_posts[0]->slug) }}">{{ $popular_posts[0]->title }}</a></h2>
            ...
            <div class="col-lg-6 pl-lg-4">
                @for ($i = 1; $i < 4; $i++)
                    <div class="entry3 d-block d-sm-flex">
                        <figure class="figure order-2"><a href="{{ route('post.detail', $popular_posts[$i]->slug) }}"><img src="{{ $popular_posts[$i]->post_image }}" alt="Image" class="img-fluid rounded"></a></figure>
                        <div class="text mr-4 order-1">
                            ...
                            <h2><a href="{{ route('post.detail', $popular_posts[$i]->slug) }}">{{ $popular_posts[$i]->title }}</a></h2>
